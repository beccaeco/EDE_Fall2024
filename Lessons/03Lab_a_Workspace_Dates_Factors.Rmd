...
library(here)
#Note this package may conflict with plyr and lubridate
...
filename <- here('EDE_Fall2024','Data','Raw','USGS_Site02085000_Flow_Raw.csv')
print(filename)
...
usgs_flow_data <- read.csv(
  file = here('EDE_Fall2024','Data','Raw','USGS_Site02085000_Flow_Raw.csv'),
  stringsAsFactors = T
)

#Create and print a list of all files in a folder using "dir" and "here"
filenames <- dir(here('EDE_Fall2024','Data','Raw'),pattern = ("*.csv"))
print(filenames)
```
...
ntl_lter_lake_data <- read.csv(
  file = here('EDE_Fall2024','Data','Raw','NTL-LTER_Lake_ChemistryPhysics_Raw.csv'),
  stringsAsFactors = T
)
...
filefolder <- here('EDE_Fall2024','Data','Raw')

EPAair_files <- dir(filefolder,pattern = ("EPAair_O3*"),full.names=TRUE)
...
sites <- read.csv(here('EDE_Fall2024/Data/Raw/NWIS_SiteFlowData_NE_RAW.csv'))
dim(sites)
