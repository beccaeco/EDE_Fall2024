...
AICpm25ozone <- lm(data = EPAair, PM2.5 ~ Ozone + mean_Lat + mean_Lng + Month + Year)

step(AICpm25ozone) #want to lower AIC
...
AICpm25ozone_best <- lm(data = EPAair, PM2.5 ~ Ozone + mean_Lat + mean_Lng + Month)

summary(AICpm25ozone_best)
