...
Litter.anova.plot <- ggplot(Litter, aes(y = dryMass, x = nlcdClass, color = functionalGroup)) +
  geom_boxplot() +
   # stat_summary(geom = "text", fun = max, vjust = -1, size = 3.5, label = c("d", "b", "", "bcd", "bcd", "a", "d", "abcd", "cd", "d", "abcd", "abcd"))
print(Litter.anova.plot)

#is adding labels manual? it looks like it's manual in the one-way test we did
