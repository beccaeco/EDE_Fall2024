...
#Lists values of both vectors
c(vector1, vector4)

#Multiplies the values of the vectors row by row
vector1 * vector4
...
#Lists the opposite of the logical values in vector 3
!vector3
...
#dataframe needs to have same number of rows
