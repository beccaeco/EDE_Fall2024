...
>Answer: look at potential relationships between variables, clean up any errors
...
> Answer: distribution of data, relation between amount of discharge and height of discharge (trend upward together)


How can multiple options for data exploration inform our understanding of our data?

> Answer: compare different elements, see how common values are (if they're close in range)
...
> Answer: heavy rain could cause increased discharge and height? bigger range on what is approved?
