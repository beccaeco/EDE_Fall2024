...
summary_PM25$mean_PM2.5 <- round(summary_PM25$mean_PM2.5, digits=2)
...
summary_Ozone$mean_Ozone <- round(summary_Ozone$mean_Ozone, digits=2)
...
```{r  fig.cap="Ozone Concentrations by Month 2018", fig.width=7, fig.height=4, fig.align= "left", echo=FALSE, warning=FALSE}
...
ozonebymonth2018 <- epa_data %>%
  ...
  xlab("Month")+
  labs(title = "Ozone Concentrations by Month in 2018")+
...
```{r  fig.cap="Ozone Concentrations by Month 2019", fig.width=7, fig.height=4, fig.align= "left", echo=FALSE, warning=FALSE}
...
ozonebymonth2019 <- epa_data %>%
  ...
  ylab(expression(paste("Concentration " , (~mu~g/m^{3}))))+
  xlab("Month")+
  labs(title = "Ozone Concentrations by Month in 2019")+
  scale_x_discrete(limits = month.abb)
...
https://github.com/beccaeco/EDE_Fall2024
